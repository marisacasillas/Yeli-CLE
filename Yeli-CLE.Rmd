...
Next up:
- ODS
- (lack of) change with age expectation
- burstiness
- vocmat looks similar

- daylong data and/or quantitative measures may not be suitable to capturing ideological differences (add refs to variance in parental lg dev ideas in US?)
-->

<!--
On the other hand, the Rossel child speech environment contains ample overhearable speech; much more than has been reported elswhere, at time of writing. The low relative rate of TCDS and the high incidence of ODS may be partly attributable to the fact that several speakers are typically present across the day, as discussed further below.
