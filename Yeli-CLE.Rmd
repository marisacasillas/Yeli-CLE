...
abstract: |
  We use daylong recordings to investigate how much speech is available to young children (0;0--3;0) on Rossel Island, Papua New Guinea. Daylong recordings give us access to children's broader language landscapes, including how the rate of linguistic input varies depending on child age, time of day, and number of speakers present. Our daylong approach follows prior detailed ethnographic study on caregiver-child interaction in this same community. We find that children's daylong language exposure does not align with the practices evident in close inspection of typical interactions. Instead, children's linguistic input rates are primarily affected by circumstantial aspects of everyday life (e.g., the presence of other speakers). We discuss the different insights afforded by these approaches in a comparative cross-cultural framework and how the findings relate to the bigger question of how minimal linguistic experience can support first language development.
