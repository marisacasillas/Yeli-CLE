...
``` {r fig5, echo=FALSE, fig.cap="By-child average proportion of TCDS from other children in a clip; shown for the random (purple) and turn taking (green) samples, and sorted by child age.", message=FALSE, warning=FALSE, fig.height=2.5}
propchitcds.plot.rand_and_tt
```
