...
## **Implications for language learning models**
**Despite hearing relatively little directed linguistic input, these 10 Rossel children show no sign of delay in their achievement of early linguistic milestones, including the use of single and multi-word utterances. This finding is hard to explain under any theory of language learning that requires substantial linguistic input [see also @casillas2019early]. While the onset of canonical babble appears highly robust [e.g., @oller1998late; @oller1995extreme; @cychoszIPchivocOSF; but see also @lee2018babbling], the stable use of individual phonological segments in speech-like babble and the subsequent appearance of recognizable words is indeed variable between children [@mcgillion2017paves; see also REFS McCune & Vihman 2001] and, further on, children's early productive vocabulary size predicts their later syntactic development, including early word combinations [@frankIPvariability; @marchman2004language]. Notably, much prior work linking linguistic input to language development focuses on vocabulary growth, which we do not measure here. Vocabulary development on Rossel Island may indeed still be sensitive to the quantity of (quality) CDS children encounter since, for example, referentially transparent utterances should still facilitate the acquisition of word meanings. That said, our impression is that such variation does not play a meaningful role in the child's development as a full-fledged member of the language community, and future work exploring effects along these lines would likely need to interpret them with respect to the mechanisms underlying human language learning at large, and not as prerequisites for normative language development on Rossel Island.**

**Following a similar set of findings regarding both the language environment and vocal maturity of Tseltal-learning children, Casillas and colleagues [-@casillas2019early] suggested three ways in which children might proceed in language learning without delay despite hearing relatively little directed speech: (a) an ability to learn from observing others' language use [see also @deleon2011language; @rogoff2003firsthand; @shneidman2010language; @shneidman2012language], (b) the routine and predictable interactional structures in which language is embedded day to day, and (c) a natural cycle in which children frequently sleep following short bursts of interactional linguistic input such that these short-term memories of directed input can be consolidated before significant interference takes place [@gomez2006naps; @horvath2016daytime; @kurdziel2013sleep; @mullally2014learning]. These three proposals, which are not mutually exclusive, may also apply in the case of Rossel children, considering that the overall characteristics of the environment are quite similar. To these proposals we add that, in general, the present findings support theorized mechanisms for language learning that efficiently capitalize on sparse bursts of CDS and/or overhearable speech (e.g., processes underlying massed learning, as in @schwab2016repetition; error-driven learning, as in REFS Elman 1990 and Chang et al., 2006 among others; or attention to others' talk, as in @akhtar2005robustness; @shneidman2012counts), particularly those that thrive under conditions of transient but contextually constrained language experiences [@bruner1983childs; @christiansen2016now; @shatz1978development]. For example, <!--eep... Chang et al., 2006; Elman, 1990; Seidenberg & MacDonald, 1999-->. In contrast, models of learning that rely on pedagogical cueing or frequent and fitted responses to infant vocalizations by an adult caregiver are not easily reconciled with the results presented here, or indeed in several other rural traditional settings [@brown2014interactional; @cristia2017child; @gaskins2006cultural; @ochs1984language; @shneidman2012language; @scaffIPlanguage; @vogt2015communicative].**

<!--to do
consider how language acquisition occurs, given such circumstances ... the paper offers the argument that the bursts of high-density input provide the data for learning and the quiet periods offer the opportunity for consolidation (learning and memory sense or also off-line processing of stored, unanalyzed input?)... a serious treatment of this hypothesis needs to make this clear and then also tackle how such a proposal fits with other proposed models of language acquisition. Hypothesis testing v. building networks approaches, and the now-or-never bottleneck argument (multiple papers and a book by N. Chater and C. Mortensen).
-->
