...
# Introduction {#intro}
In their first five years of life, children hear an extraordinary amount of language in a wide variety of interactional contexts. Tracking the distribution and characteristics of this linguistic input over whole waking days, across developmental time, and between different families is a difficult task. Traditionally, developmental language science has relied on short video recordings of caregiver-child interaction, at home or in the lab, to get a grasp on what kinds of language children typically hear. This has been a fruitful approach in teasing out individual and group-based differences in interactional style (REFS).

Short, multimodal recordings (e.g., audio plus video data, motion tracking, eye movements), give rich insight into the moment-to-moment characteristics of interaction and, given the extra context from the multi-modal recording, increase the transparency of what is meant by each communicative behavior. Short, multi-model recordings can be made in nearly any context, take little time to make, and have been shown to be consistent with other, more costly and time-consuming recording styles (REFS). When paired with intensive ethnographic study, these recordings become potent samples of typical language environments and caregiving behaviors in the studied community. Ethnographic work situates the context for recording collection, the behaviors for analysis, and data interpretation in what is considered normal and relevant within that community; decisions on what to study and precisely how are informed by knowledge of daily tasks, typical household relations and responsibilities, attitudes about child rearing, considerations about when children qualify as co-interactants, and what behaviors are expected of children and caregivers in the first years of life. In a situation where the researcher is a member of the community under study, assumptions about what to study and how are implicitly enriched by this knowledge. However, when the researcher is a visitor to the community, selecting the right measures and finding ways to compare them to child development outcomes in other sites is an enormous challenge.
...
are limited in their insight because they represent only a small slice of the child's language abilities and experiences (REFS).
